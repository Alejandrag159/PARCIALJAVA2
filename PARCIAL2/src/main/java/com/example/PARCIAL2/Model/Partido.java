...
public class Partido {
    ...
    public Partido(Integer idPartido, LocalDate fecha, String estadio, Integer golesLocal, Integer golesVisita, Equipo equipoLocal, Equipo equipoVisita, List<EstadisticaJugador> estadisticas) {
